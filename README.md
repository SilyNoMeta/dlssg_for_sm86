...
based on [sdli1995/dlssg_for_sm86](https://github.com/sdli1995/dlssg_for_sm86). One **`version.dll`** contains
...
DXVK, RTX 20 and alternate proxy names are not validated. No Python/CUDA installation
